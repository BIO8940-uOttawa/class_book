...
You can see an example of the \href{data/examples/rmarkdown_practical.Rmd}{Rmarkdown} and \href{data/examples/rmarkdown_practical.pdf}{pdf} output \href{data/examples}{here}

\begin{figure}

{\centering \includegraphics[width=0.2\linewidth]{images/lter_penguins} 
